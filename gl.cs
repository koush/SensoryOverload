...
namespace OpenGLES
{
    public static class gl
    {
        ...
        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glCompressedTexSubImage2D")]
        ...
        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glCopyTexImage2D")]
        ...
        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glCopyTexSubImage2D")]
        ...
        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glCullFace")]
        public static extern void CullFace(uint mode);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDeleteBuffers")]
        unsafe public static extern void DeleteBuffers(int n, uint* buffers);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDeleteTextures")]
        unsafe public static extern void DeleteTextures(int n, uint* textures);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDepthFunc")]
        public static extern void DepthFunc(uint func);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDepthMask")]
        public static extern void DepthMask(byte flag);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDepthRangex")]
        public static extern void DepthRangex(int zNear, int zFar);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDisable")]
        public static extern void Disable(uint cap);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDisableClientState")]
        public static extern void DisableClientState(uint array);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDrawArrays")]
        public static extern void DrawArrays(uint mode, int first, int count);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glDrawElements")]
        public static extern void DrawElements(uint mode, int count, uint type, System.IntPtr indices);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glEnable")]
        public static extern void Enable(uint cap);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glEnableClientState")]
        public static extern void EnableClientState(uint array);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glFinish")]
        public static extern void Finish();

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glFlush")]
        public static extern void Flush();

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glFogx")]
        public static extern void Fogx(uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glFogxv")]
        unsafe public static extern void Fogxv(uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glFrontFace")]
        public static extern void FrontFace(uint mode);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glFrustumx")]
        public static extern void Frustumx(int left, int right, int bottom, int top, int zNear, int zFar);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetBooleanv")]
        public static extern void GetBooleanv(uint pname, System.IntPtr @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetBufferParameteriv")]
        unsafe public static extern void GetBufferParameteriv(uint target, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGenBuffers")]
        unsafe public static extern void GenBuffers(int n, uint* buffers);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGenTextures")]
        unsafe public static extern void GenTextures(int n, uint* textures);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetError")]
        public static extern uint GetError();

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetFixedv")]
        unsafe public static extern void GetFixedv(uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetIntegerv")]
        unsafe public static extern void GetIntegerv(uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetLightxv")]
        unsafe public static extern void GetLightxv(uint light, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetMaterialxv")]
        unsafe public static extern void GetMaterialxv(uint face, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetPointerv")]
        unsafe public static extern void GetPointerv(uint pname, IntPtr* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetString")]
        public static extern System.IntPtr GetString(uint name);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetTexEnviv")]
        unsafe public static extern void GetTexEnviv(uint env, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetTexEnvxv")]
        unsafe public static extern void GetTexEnvxv(uint env, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetTexParameteriv")]
        unsafe public static extern void GetTexParameteriv(uint target, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetTexParameterxv")]
        unsafe public static extern void GetTexParameterxv(uint target, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glHint")]
        public static extern void Hint(uint target, uint mode);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glIsBuffer")]
        public static extern byte IsBuffer(uint buffer);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glIsEnabled")]
        public static extern byte IsEnabled(uint cap);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glIsTexture")]
        public static extern byte IsTexture(uint texture);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLightModelx")]
        public static extern void LightModelx(uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLightModelxv")]
        unsafe public static extern void LightModelxv(uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLightx")]
        public static extern void Lightx(uint light, uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLightxv")]
        unsafe public static extern void Lightxv(uint light, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLineWidthx")]
        public static extern void LineWidthx(int width);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLoadIdentity")]
        public static extern void LoadIdentity();

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLoadMatrixx")]
        public static extern void LoadMatrixx(ref int m);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glLogicOp")]
        public static extern void LogicOp(uint opcode);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glMaterialx")]
        public static extern void Materialx(uint face, uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glMaterialxv")]
        unsafe public static extern void Materialxv(uint face, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glMatrixMode")]
        public static extern void MatrixMode(uint mode);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glMultMatrixx")]
        unsafe public static extern void MultMatrixx(int* m);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glMultiTexCoord4x")]
        public static extern void MultiTexCoord4x(uint target, int s, int t, int r, int q);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glNormal3x")]
        public static extern void Normal3x(int nx, int ny, int nz);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glNormalPointer")]
        public static extern void NormalPointer(uint type, int stride, System.IntPtr pointer);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glOrthox")]
        public static extern void Orthox(int left, int right, int bottom, int top, int zNear, int zFar);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPixelStorei")]
        public static extern void PixelStorei(uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPointParameterx")]
        public static extern void PointParameterx(uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPointParameterxv")]
        unsafe public static extern void PointParameterxv(uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPointSizex")]
        public static extern void PointSizex(int size);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPolygonOffsetx")]
        public static extern void PolygonOffsetx(int factor, int units);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPopMatrix")]
        public static extern void PopMatrix();

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPushMatrix")]
        public static extern void PushMatrix();

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glReadPixels")]
        public static extern void ReadPixels(int x, int y, int width, int height, uint format, uint type, System.IntPtr pixels);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glRotatex")]
        public static extern void Rotatex(int angle, int x, int y, int z);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glSampleCoverage")]
        public static extern void SampleCoverage(float value, byte invert);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glSampleCoveragex")]
        public static extern void SampleCoveragex(int value, byte invert);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glScalex")]
        public static extern void Scalex(int x, int y, int z);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glScissor")]
        public static extern void Scissor(int x, int y, int width, int height);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glShadeModel")]
        public static extern void ShadeModel(uint mode);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glStencilFunc")]
        public static extern void StencilFunc(uint func, int @ref, uint mask);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glStencilMask")]
        public static extern void StencilMask(uint mask);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glStencilOp")]
        public static extern void StencilOp(uint fail, uint zfail, uint zpass);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexCoordPointer")]
        public static extern void TexCoordPointer(int size, uint type, int stride, System.IntPtr pointer);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexEnvi")]
        public static extern void TexEnvi(uint target, uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexEnvx")]
        public static extern void TexEnvx(uint target, uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexEnviv")]
        unsafe public static extern void TexEnviv(uint target, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexEnvxv")]
        unsafe public static extern void TexEnvxv(uint target, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexImage2D")]
        public static extern void TexImage2D(uint target, int level, int internalformat, int width, int height, int border, uint format, uint type, System.IntPtr pixels);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexParameteri")]
        public static extern void TexParameteri(uint target, uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexParameterx")]
        public static extern void TexParameterx(uint target, uint pname, int param);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexParameteriv")]
        unsafe public static extern void TexParameteriv(uint target, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexParameterxv")]
        unsafe public static extern void TexParameterxv(uint target, uint pname, int* @params);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTexSubImage2D")]
        ...
        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glTranslatex")]
        public static extern void Translatex(int x, int y, int z);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glVertexPointer")]
        public static extern void VertexPointer(int size, uint type, int stride, System.IntPtr pointer);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glViewport")]
        public static extern void Viewport(int x, int y, int width, int height);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glPointSizePointerOES")]
        public static extern void PointSizePointerOES(uint type, int stride, System.IntPtr pointer);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetClipPlanef")]
        unsafe public static extern void GetClipPlanef(uint pname, float* eqn);

        [DllImportAttribute("libGLESv1_CM.so", EntryPoint = "glGetClipPlanex")]
